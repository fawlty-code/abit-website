...
<div class="grid grid-cols-3 p-2">
    <div class="p-4 pl-12 col-span-1">
        <span class="text-6xl text-too-red font-anton font-bold">ASHOKA BEHAVIOURAL INSIGHTS TEAM</span>
        <div class="text-xl text-royal-blue font-tt-hoves font-extrabold">Striving to drive<br>impactful change</div>
    </div>
    ...
    <div class="w-full flex flex-col items-center">
        ...
        <div class="flex flex-col p-4.5 bg-[url('$lib/assets/radial.png')] bg-center bg-contain bg-no-repeat w-full">
            <div class="grid grid-cols-6 grid-rows-6 pr-6 gap-1.5 text-slate-gray text-2xl font-semibold font-tt-hoves">    
                ...
                <Card 
                gridProps='row-start-2 row-span-2 col-start-4 col-span-3' 
                imageProps='self-start'
                imageSrc={circle}
                imageSize=100
...
<div class="pl-1.5 flex">
    ...
    {#if whatwedoVisible}
        <span class="text-5xl text-royal-blue font-tt-hoves font-bold" transition:fly={{delay:100, y:100, duration:1000}}>What We Do?</span>
    {:else}
        <span class="text-5xl text-royal-blue font-tt-hoves font-bold opacity-0">What We Do?</span>
    {/if}
    </div>
</div>
