...
<div class="grid grid-cols-2">
    <img src={deco} alt="80s deco background" class="col-start-1 row-start-1 col-span-2 p-8 pr-36">
    <div class="grid grid-rows-4 px-12">

    </div>
    <div class="grid grid-rows-2 px-12 gap-36">
...
<div class="flex justify-between my-9">
    ...
    <div class="flex flex-col p-4.5">
        ...
        <div class="grid grid-cols-6 grid-rows-6 pr-6 gap-1.5 text-slate-gray text-xl font-semibold font-tt-hoves">
            ...
            <div class="flex bg-off-white p-3 rounded-2xl row-start-2 row-span-2 col-start-4 col-span-3">
                <span class="self-start">Why do we need it?</span>
                <img src={circle} alt="circle" height="100" width="100">
            </div>
            <div class="flex bg-off-white p-3 rounded-2xl row-start-4 row-span-2 col-start-1 col-span-3">
                <img src={star} alt="star" height="100" width="100">
                <span>What is the scope for the future?</span>
            </div>
            <div class="grid grid-rows-2 bg-off-white p-3 rounded-2xl row-start-4 row-span-3 col-start-4 col-span-2">
